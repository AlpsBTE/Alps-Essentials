...
public class ServerUtils {
    ...
    private static void connectToServer(Server server, Player player) {
        ByteArrayDataOutput out = ByteStreams.newDataOutput();
    ...
    public static void connectToServer(boolean isOnline, Server server, Player player) {
        if (isOnline) {
            ...
            ServerUtils.connectToServer(server, player);
        } else {
